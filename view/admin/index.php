			...
			<div class="main">
				<?php			
					if (isset($_POST["manhinh"]) ){
						...
						switch ($manhinh){
							case "nllda":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/admin/ateEmployeeManage.php");
								break;
							case "menuList":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/admin/menuList.php");
								break;
							case "dishList":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/admin/dishList.php");
								break;			
							case "newDish":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/admin/newDish.php");
								break;
							case "listAccount":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/admin/accountList.php");
								break;
							case "createAccount":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/admin/createAccount.php");
								break;
							case "changeInfo":
