			...
			<div class="main">
				<?php			
					if ( isset($_POST["manhinh"]) ){
						...
						switch ($manhinh){
							case "dayMen":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/client/dayMenu.php");					
								break;
							case "weekMen":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/client/weekMenu.php");
								break;
							case "specificDay":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/client/registerSpecificDay.php");
								break;
							case "statistic":
								include_once($_SERVER['DOCUMENT_ROOT']."/ABC/view/client/statistic.php");
								break;
							case "changeInfo":
